...
export const auth = async (fastify) => 
{
    ...
    fastify.post ('/reset-password', authController.forward.bind (authController));

    fastify.post('/verify-user', { schema: schemas.codeSchema }, authController.forward.bind(authController));
    fastify.post('/resend-otp', { schema: schemas.emailSchema }, authController.forward.bind(authController));
